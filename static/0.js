...
/***/ "./node_modules/css-loader/index.js?{\"sourceMap\":true,\"minimize\":{\"autoprefixer\":{\"add\":true,\"remove\":true,\"browsers\":[\"last 2 versions\"]},\"discardComments\":{\"removeAll\":true},\"discardUnused\":false,\"mergeIdents\":false,\"reduceIdents\":false,\"safe\":true,\"sourcemap\":true}}!./node_modules/sass-loader/lib/loader.js?{\"sourceMap\":true,\"includePaths\":[\"C:/projects/geocoder-ie/ui/src/styles\"]}!./src/routes/classifier/components/sentences.scss":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".corpora{font-size:11px;font-family:Arial}.corpora .search{width:60%;height:44px;font-size:14px}.corpora table,.corpora td{border:1px solid #000;text-align:left;padding:5px}.corpora .delete,.corpora .geo,.corpora .none{height:22px;border:0;padding:2px;margin:2px}.corpora .pagination{display:block;text-align:center}.corpora .pagination li{display:inline;padding:4px}.corpora a{cursor:pointer}.corpora tr.none{background-color:#ccc}.corpora tr.geography{background-color:green}.corpora tr.geography a{color:#fff}", "", {"version":3,"sources":["C:/projects/geocoder-ie/ui/src/routes/classifier/components/src/routes/classifier/components/sentences.scss"],"names":[],"mappings":"AAAA,SACE,eAAe,AACf,iBAAkB,CAgDnB,AAlDD,iBAKI,UAAU,AACV,YAAY,AACZ,cAAe,CAChB,AARH,2BAWI,sBAAsB,AACtB,gBAAgB,AAChB,WAAY,CACb,AAdH,8CAmBI,YAAY,AACZ,SAAW,AACX,YAAY,AACZ,UAAW,CACZ,AAvBH,qBA0BI,cAAc,AACd,iBAAkB,CAMnB,AAjCH,wBA8BM,eAAe,AACf,WAAY,CACb,AAhCL,WAoCI,cAAe,CAChB,AArCH,iBAwCI,qBAAsB,CACvB,AAzCH,sBA4CI,sBAAuB,CAKxB,AAjDH,wBA+CM,UACF,CAAE","file":"sentences.scss","sourcesContent":[".corpora {\r\n  font-size: 11px;\r\n  font-family: Arial;\r\n\r\n  .search{\r\n    width: 60%;\r\n    height: 44px;\r\n    font-size: 14px;\r\n  }\r\n  table,\r\n  td {\r\n    border: 1px solid #000;\r\n    text-align: left;\r\n    padding: 5px;\r\n  }\r\n\r\n  .geo,\r\n  .none,\r\n  .delete {\r\n    height: 22px;\r\n    border: 0px;\r\n    padding: 2px;\r\n    margin: 2px;\r\n  }\r\n\r\n  .pagination {\r\n    display: block;\r\n    text-align: center;\r\n\r\n    li {\r\n      display: inline;\r\n      padding: 4px;\r\n    }\r\n  }\r\n\r\n  a {\r\n    cursor: pointer;\r\n  }\r\n\r\n  tr.none {\r\n    background-color: #CCC;\r\n  }\r\n\r\n  tr.geography {\r\n    background-color: green;\r\n\r\n    a{\r\n      color: #FFF\r\n    }\r\n  }\r\n}\r\n"],"sourceRoot":""}]);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = getSentences;
/* harmony export (immutable) */ __webpack_exports__["b"] = deleteSentenceById;
/* harmony export (immutable) */ __webpack_exports__["c"] = updateSentenceById;
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(Sentences, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement('input', { type: 'text', className: 'search', onChange: function onChange(e) {
            return onSearchChange(e.target.value);
          }, value: term }),
        __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement('input', { type: 'button', className: 'none', value: 'Search', onClick: onSearch }),
...
if(true) {
	...
	if(!content.locals) {
		module.hot.accept("./node_modules/css-loader/index.js?{\"sourceMap\":true,\"minimize\":{\"autoprefixer\":{\"add\":true,\"remove\":true,\"browsers\":[\"last 2 versions\"]},\"discardComments\":{\"removeAll\":true},\"discardUnused\":false,\"mergeIdents\":false,\"reduceIdents\":false,\"safe\":true,\"sourcemap\":true}}!./node_modules/sass-loader/lib/loader.js?{\"sourceMap\":true,\"includePaths\":[\"C:/projects/geocoder-ie/ui/src/styles\"]}!./src/routes/classifier/components/sentences.scss", function() {
...
function loadSentences(params) {
  return function (dispatch, getState) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_api__["a" /* getSentences */])(params).then(function (response) {
      dispatch({
...
function deleteSentence(id) {
  return function (dispatch, getState) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_api__["b" /* deleteSentenceById */])(id).then(function (response) {
...
function updateSentence(id, category) {
  return function (dispatch, getState) {
    var term = getState().getIn(['classifier', 'term']);
    var page = getState().getIn(['classifier', 'page']);

    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_api__["c" /* updateSentenceById */])(id, category).then(function (response) {
      dispatch(loadSentences({ page: page, query: term }));
    }).catch(function (error) {
      console.log(error);
    });
  };
